...
import vesakLanternImage from '../assets/images/vesak4.jpg'; 
import pottuImage from '../assets/images/kukum.png'; 
import elephantImage from '../assets/images/woodenElephant.png'; 
function HomePage() {
  // Defines an array of objects, each representing a featured cultural/religious event. 
  ...
  // Defines an array of objects, each representing a featured product. 
  ...
  const heroSectionStyle = {
    background: 'linear-gradient(45deg,rgb(116, 116, 118),rgb(20, 123, 179))',
  ...
  // Inline style for hero section before pseudo-element
  ...
  // Inline style for product/event card images
  const cardImgStyle = {
    width: '100%',
    height: '250px',
    objectFit: 'cover',
  ...
  return (
    <div>{/* Main container div for the HomePage */} 
      {/* Hero Section - The prominent top section of the page */}
      ...
      {/* Cultural Festivals Call to Action Section*/}
      <div className="container my-5 text-center">
        <div className="bg-light p-5 rounded-3 shadow-sm">
          ...
          {/* Link button to the Cultural Festivals page */} 
      ...
      {/* Featured Products Call to Action Section*/}
      <div className="container my-5 text-center">
        <div className="bg-light p-5 rounded-3 shadow-sm">
    ...
    <h2 className="text-center mb-4 display-6 fw-bold">Featured Upcoming Religious & Cultural Events</h2>
     <div className="row g-4">
      ...
      <div className="col-md-6 col-lg-4" key={event.id}>
        ...
        // Inline onMouseOver for card hover effect 
          onMouseOver={(e) => {
        ...
        // Inline onMouseOut for card hover effect revert
           onMouseOut={(e) => {
           e.currentTarget.style.transform = 'translateY(0) scale(1)';
...
// Exports the HomePage component for use in other parts of the application.